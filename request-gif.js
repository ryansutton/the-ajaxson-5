    ...
    if (verify()) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                img_source = response.data.image_url;
                $("#gif").attr("src", img_source);
        ...
        console.log('last chance', $('#feedback').text());
    } else {
...
function verify() {
    riddle_answer = $("#verify").val().toLowerCase()
    console.log(riddle_answer)
    if (riddle_answer === "5" || riddle_answer === "five") {
        return true
    } else {
        return false
    }
